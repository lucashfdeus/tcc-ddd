package com.ms.emailDdd.email.application.services;


import com.ms.emailDdd.email.application.domain.Email;
import com.ms.emailDdd.email.application.domain.PageInfo;
import com.ms.emailDdd.email.application.domain.enums.StatusEmail;
import com.ms.emailDdd.email.application.ports.EmailRepositoryPort;
import com.ms.emailDdd.email.application.ports.EmailServicePort;
